...
urlpatterns = [
    ...
    path('doVideoImgModal', views.doVideoImgModal),
    path('deleteComment', views.deleteComment),
    path('deleteCollect', views.deleteCollect),
    path('deleteHistory', views.deleteHistory),
    path('getFunctions', views.getFunctions),
    path('getVideosWithFunction', views.getVideosWithFunction),
    path('getCommentForAdmin', views.getCommentForAdmin),
    path('delCommentForAdmin', views.delCommentForAdmin),
    path('getCommentWithVideoIDForAdmin', views.getCommentWithVideoIDForAdmin),
    path('getCommentWithUserIDForAdmin', views.getCommentWithUserIDForAdmin),
    path('uploadvideo1', back_views.uploadvideo1),
]
