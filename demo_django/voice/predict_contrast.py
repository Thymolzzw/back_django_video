...
parser.add_argument('--audio1_path', default='audio/hellozzw.m4a', type=str, help='contrast person1 audio path')
parser.add_argument('--audio2_path', default='audio/hellozzw.wav', type=str, help='contrast person2 audio path')
